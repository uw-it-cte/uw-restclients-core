...
class TestTimingLog(TestCase):
    ...
    @override_settings(RESTCLIENTS_TIMING_START=(datetime.datetime.now() + datetime.timedelta(1)).isoformat(),
                       RESTCLIENTS_TIMING_END=(datetime.datetime.now() + datetime.timedelta(2)).isoformat(),
